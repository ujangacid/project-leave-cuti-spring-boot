...
public interface query {
    //people
    String createPeople="insert into people (name,address,position,nip) values (:name,:address,:position,:nip) returning *";
    String listPeople = "select id,name,address,position,nip from people order by id asc";
    String getPeopleById = "select id,name,address,position,nip from people where id = :id";
    String getPeopleByNip = "select nip,password from people where nip= :nip";
    String updatePeople = "update people set name=:name,address=:address,position=:position,nip=:nip where id=:id returning *";
    ...
    //leave
    String createLeave = "insert into leave (type,cuti) values (:type,:cuti) returning *";
    ...
    String getLeaveById = "select id,type,cuti from leave where id = :id";
    String updateLeave = "update leave set type = :type, cuti = :cuti where id = :id";
    String deleteLeave = "delete from leave where id = :id";

    //leave request
    String createLeaveRequest = "insert into leave_request (people_id,leave_id,start_date,end_date,reason) values (:people_id,:leave_id,:start_date,:end_date,:reason) returning *";
